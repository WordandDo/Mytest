...
def prepare_2wiki(
    output_kb_file_path: str = "2wikimultihopqa_val_kb.json",
    output_query_file_path: str = "2wikimultihopqa_val.jsonl"
) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    """
    Downloads the 2WikiMultihopQA validation set and processes it into two files:
